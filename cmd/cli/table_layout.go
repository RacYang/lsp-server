...
//	行 10..12 中央提示/浮窗(高 3)
//	行 13     间隔
//	行 14..18 你的手牌+提示(高 5,其中 4 行字符画+1 行提示)
//	行 19     兜底
//
// 实际实现保留少量自适应：屏幕越大,中央区与下方手牌区按比例向下放。
